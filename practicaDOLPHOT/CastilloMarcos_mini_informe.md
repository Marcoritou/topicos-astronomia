...
![](downloaddolphot1.jpg "imagen")
### 4.4: Estimacion de la TRGB
Para estimar la magnitud aparente de la TRGB de utiliza el metodo basado en la funcion de luminosidad de las estrellas del catalogo, este metodo se basa en el cambio brusco, o mas bien el cambio de la pendiente de la funcion de luminosidad, como marca de la TRGB.

Para ello la funcion de luminosidad de nuestro catalogo es tal que:
...
Para estimar $t_j$ se toma una region del CMD, para considerar las estrellas que pasan por una dada etapa evolutiva y se cuentan, de esta manera sabiendo que:

### 4.6: Ajuste de isocronas
Finalmente se ajustan isocronas a nuestro CMD obtenido para estimar la edad, en este caso se utiliza un metodo "eyeball", por lo que se consideran...
